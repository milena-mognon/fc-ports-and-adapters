...
import (
	...
	dbInfra "github.com/milena-mognon/fc-ports-and-adapters/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.fc-ports-and-adapters.yaml)")
