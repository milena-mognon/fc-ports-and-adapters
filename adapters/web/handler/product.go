...
import (
	...
	"github.com/milena-mognon/fc-ports-and-adapters/adapters/dto"
	"github.com/milena-mognon/fc-ports-and-adapters/application"
)

func MakeProductHanldlers(r *mux.Router, n *negroni.Negroni, service application.ProductServiceInterface) {
